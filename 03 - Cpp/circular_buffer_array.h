...
template <class T, size_t max_size>
void CircularBuffer<T, max_size>::write(T item) noexcept {
  buffer_[tail_] = item;
  if (is_full_) {
...
template <class T, size_t max_size>
std::optional<T> CircularBuffer<T, max_size>::read() noexcept {
...
template <class T, size_t max_size>
std::optional<T> CircularBuffer<T, max_size>::get() noexcept {
  if (empty()) return std::nullopt;
  return buffer_[head_];
}

template <class T, size_t max_size>
void CircularBuffer<T, max_size>::reset() noexcept {
  tail_ = head_;
  is_full_ = false;
}

template <class T, size_t max_size>
size_t CircularBuffer<T, max_size>::size() const noexcept {
